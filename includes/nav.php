        ...
        <nav class="sidebar-nav">
            ...
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <a class="sidebar-link" href="#featuresDropdown" data-bs-toggle="collapse" aria-expanded="false">

                        <i data-feather="grid" class="feather-icon"></i>

                        <span class="hide-menu w-100 d-flex justify-content-between align-items-center">
                    ...
                    <ul id="featuresDropdown" class="collapse list-unstyled ps-4" data-bs-parent="#sidebarnav">

                        <li class="sidebar-item my-2">

                            <a href="../rooms/index.php" class="sidebar-link text-decoration-none text-muted" style="padding: 8px 15px;">

                                <i class="fas fa-bed me-2"></i> <span class="hide-menu">Manage Rooms</span>
                        ...
                        <li class="sidebar-item mb-2">
                            ...
                            <a href="../students/index.php" class="sidebar-link text-decoration-none text-muted" style="padding: 8px 15px;">

                                <i class="fas fa-users me-2"></i> <span class="hide-menu">Hostel Students</span>
                ...
                <li class="sidebar-item">
                    ...
                    <a class="sidebar-link" href="#reportsDropdown" data-bs-toggle="collapse" aria-expanded="false">
                    ...
                    <ul id="reportsDropdown" class="collapse list-unstyled ps-4" data-bs-parent="#sidebarnav">

                        <li class="sidebar-item my-2">

                            <a href="../reports/occupancy_report.php" class="sidebar-link text-decoration-none text-muted" style="padding: 8px 15px;">

                                <i class="fas fa-chart-pie me-2"></i> <span class="hide-menu">Occupancy Report</span>
                        ...
                        <li class="sidebar-item mb-2">
                            ...
                            <a href="../reports/revenue_report.php" class="sidebar-link text-decoration-none text-muted" style="padding: 8px 15px;">

                                <i class="fas fa-dollar-sign me-2"></i> <span class="hide-menu">Revenue Report</span>
