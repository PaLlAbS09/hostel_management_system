                    ...
                    <tbody>
                        <?php foreach ($rooms as $room): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($room['block_floor']) ?></td>
                                <td><?= htmlspecialchars($room['capacity']) ?></td>
                                <td>$<?= htmlspecialchars($room['rent']) ?></td>
                                <td>
                        ...
                        <?php if (empty($rooms)): ?>
                            <tr>
                                ...
                                <td colspan="6" class="text-center text-danger">No rooms found.</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
