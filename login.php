                        ...
                        <form class="mt-4" id="loginForm" action="./Authentication/login_process.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12 text-center">
                                    <button type="submit" class="btn btn-block w-100 btn-dark py-2">LOGIN</button>
                                </div>
                                ...
                                <div class="col-lg-12 text-center mt-3 pt-3 border-top">
                                    <span class="text-muted">New user?</span> 
                                    <a href="registration.php" class="text-primary fw-bold text-decoration-none">Register here</a>
                                </div>
